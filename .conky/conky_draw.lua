...
function draw_rectangle(display, element)
  ...
  cairo_set_source_rgba(display, hexa_to_rgb(element.fill_color, element.fill_color_alpha))
  cairo_set_line_width(display, element.stroke_width)
  cairo_rectangle(display, from_x, from_y, width, height)
  cairo_fill_preserve(display)
  cairo_set_source_rgba(display, hexa_to_rgb(element.stroke_color, element.stroke_color_alpha))
  cairo_stroke(display)
end
